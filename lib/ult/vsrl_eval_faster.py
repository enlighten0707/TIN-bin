...
class VCOCOeval(object):
  ...
  def _do_eval(self, detections_file, ovr_thresh=0.5):
    ...
    agent_ap = self._do_agent_eval(vcocodb, detections_file, ovr_thresh=ovr_thresh)
    role_ap1 = self._do_role_eval(vcocodb, detections_file, ovr_thresh=ovr_thresh, eval_type='scenario_1')
    role_ap2 = self._do_role_eval(vcocodb, detections_file, ovr_thresh=ovr_thresh, eval_type='scenario_2')
    return agent_ap, role_ap1, role_ap2
  ...
  def _do_agent_eval(self, vcocodb, dets, ovr_thresh=0.5):
